    ...
    return (
        <div className="header">
            ...
            <div className="nav-option">
                ...
                <div>Online Status: {onlineStatus?<span>🟢</span>:<span>🔴</span>}</div>
            </div>
        </div>
    )
}
